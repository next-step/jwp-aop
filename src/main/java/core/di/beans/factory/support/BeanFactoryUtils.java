...
public class BeanFactoryUtils {
    ...
    public static Constructor getInjectedConstructorWithDefault(Class<?> clazz) {
        Constructor<?> injectedConstructor = getInjectedConstructor(clazz);
        if (injectedConstructor == null) {
            return getDefaultConstructorOf(clazz);
        }
    ...
    private static Constructor<?> getDefaultConstructorOf(Class<?> clazz) {
        try {
            return clazz.getConstructor();
        } catch (NoSuchMethodException e) {
            throw new IllegalStateException("Default Constructor does not exist at bean class.", e);
        }
    }
